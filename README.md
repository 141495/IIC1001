...
| Nombre | Usuario GitHub | Mail UC |
| :-: | :-: | :-: |
| Marco Rodríguez | 141495 | mrodriguezl1@estudiante.uc.cl |

## Aportes
- Marco Rodríguez: creación del repositorio, algoritmo.py, README.md y .gitignore
